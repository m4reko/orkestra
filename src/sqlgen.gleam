// Adapted from https://github.com/aosasona/jsorm/blob/master/src/sqlgen.gleam
// Reads SQL files from sql/ and generates typed Gleam wrapper functions.
// Run with: gleam run -m sqlgen
...
fn generate_sql_function(file: String) -> Result(String, simplifile.FileError) {
